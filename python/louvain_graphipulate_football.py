...
G = Graph.Read_GraphML("football.GraphML")    #igraph version of data for partitioning

K = nx.read_graphml("football.GraphML")       #networkx version of data for json-ing
...
#print data['nodes']
with open('football_rb.js', 'w') as outfile:
