...
G = Graph.Read_GraphML("yeast.GraphML")    #igraph version of data for partitioning

K = nx.read_graphml("yeast.GraphML")       #networkx version of data for json-ing
...
#print data['nodes']
with open('yeast_rb.js', 'w') as outfile:
